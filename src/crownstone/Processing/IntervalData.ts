...
function getMinuteData(minuteCount : number, targetInterval: string, basedOnInterval: string, threshold: number) : IntervalData {
  return {
...
function getHourData(hourCount : number, targetInterval: string, basedOnInterval: string, threshold: number) : IntervalData {
  return {
...
function getDayData(targetInterval: string, basedOnInterval: string, threshold: number) : IntervalData {
  return {
...
function getWeekData(targetInterval: string, basedOnInterval: string, threshold: number) : IntervalData {
  return {
