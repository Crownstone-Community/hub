...
let AssetFilterSet = class AssetFilterSet extends (0, timestamp_mixin_1.AddTimestamps)(base_entity_1.BaseEntity) {
};
tslib_1.__decorate([
...
tslib_1.__decorate([
    (0, repository_1.hasMany)(() => asset_filter_model_1.AssetFilter, { keyTo: 'filterSetId' }),
